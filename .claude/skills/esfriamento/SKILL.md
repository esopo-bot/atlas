---
name: esfriamento
description: Fecha a sessão de trabalho colhendo o que o dia ensinou, do cético na conclusão à revisão das regras. Use só no fim da sessão — ao encerrar, quando pedirem o esfriamento ou o fechamento do dia. Um trabalho dado por pronto no meio da sessão é da skill analise-de-promocao; sessão que continua depois fecha pela skill trabalho-por-issue.
metadata:
  pedidos-de-exemplo:
