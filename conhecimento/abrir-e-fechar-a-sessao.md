...
Os três blocos que se colam, na ordem em que o dia os usa. Não repita as
regras no prompt: elas já chegam pelo `AGENTS.md` — o prompt aponta e
delimita.
...
Workspace com muitos repositórios? Acrescente:
...
Sem a skill (outro agente, outra máquina): cole os itens de
`.agents/skills/esfriamento/SKILL.md` no prompt.
