...
description: Use quando pedirem para indexar os projetos do workspace, gerar ou atualizar a wiki local, criar o perfil de um repositório, ou depois de mudança grande num projeto.
metadata:
  pedidos-de-exemplo:
