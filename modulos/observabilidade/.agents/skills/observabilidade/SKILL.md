...
A tradução dos passos para a ferramenta está em
`conhecimento/observabilidade.md`. Não recontá-los aqui é de propósito — fato
repetido em dois lugares envelhece torto e passa a mentir de um dos lados.
