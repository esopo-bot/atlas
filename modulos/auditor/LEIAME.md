...
**ainda reproduz**. Responde três perguntas que ninguém responde de graça:
...
Instalar é ligar. Não instalar é desligar. Exige a camada no destino: usa o
verificador que já existe, e não reimplementa re-execução de prova.

O auditor verifica e acusa, e não tem bandeira de promoção: rodá-lo com
`--promover` é erro de uso. Pôr um achado no quadro é decisão de quem leu o
relatório.
...
O auditor faz o contrário: **só fala do que ficou escrito**. Não lê
transcrição e não julga comportamento. A evidência é o que a etapa declarou,
e a re-execução é o que ainda se sustenta. O resto ele marca como leitura.
